...
return array (
    ...
    '{userName} assigned you as responsible person in task {task} from space {spaceName}.' => '{userName} hat dich als verantwortliche Person in Aufgabe {task} im Space {spaceName} zugewiesen.',
    ...
    '{userName} requests you to review Task {task} in space {spaceName}.' => '{userName} hat dich angefragt, Aufgabe {task} im Space {spaceName} zu überprüfen.',
