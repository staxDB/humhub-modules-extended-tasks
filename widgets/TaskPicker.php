    ...
    public function init()
    {
        ...
        if ($this->taskSearchUrl == "") {
            ...
            if (Yii::$app->controller->id == 'space') {
                ...
                $this->taskSearchUrl = Url::toRoute(['/task/search/json', 'keyword' => '-keywordPlaceholder-', 'space_id' => $spaceId]);
            } else {
                $this->taskSearchUrl = Url::toRoute(['/task/search/json', 'keyword' => '-keywordPlaceholder-']);
            }
        }
    }
