...
//    }
    ...
    {
        return self::filter(Task::find(), $keywords, $maxResults, $permission);
    }
...
//    public static function filter($query, $keywords = null, $maxResults = null, $permission = null, $active = null)
    ...
    {
        $task = self::addQueryFilter($query, $keywords, $maxResults)->all();
        return self::filterByPermission($task, $permission);
    }
