 ...
 * @since 0.5
 */
class NotifyAssigned extends BaseNotification
{
    /**
     * @inheritdoc
     */
    ...
    public function html() {
        return Yii::t('TaskModule.views_notifications_invited', '{userName} assigned you to task {task} in space {spaceName}.', [
